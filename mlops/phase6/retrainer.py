...
class LearningRetrainer:
    ...
    def should_retrain(self) -> bool:
        """Check if enough data accumulated for retraining."""
    ...
    def prepare_retraining_pool(self) -> list[dict]:
        """Combine feedback and uncertain predictions into new training data."""
    ...
    def check_if_improved(
        ...
        """Check if new model improved performance."""
